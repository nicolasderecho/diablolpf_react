  ...
  <PageContainer className="tips">
    <div className="container mx-auto px-4">
      <div className="flex flex-wrap flex-col gap-6">
        ...
        <ActAreas actData={ActOne as ActArea[]} title="Acto I" />
        <ActAreas actData={ActTwo as ActArea[]} title="Acto II" />
        <ActAreas actData={ActThree as ActArea[]} title="Acto III" />
        <ActAreas actData={ActFour as ActArea[]} title="Acto IV" />
        <ActAreas actData={ActFive as ActArea[]} title="Acto V" />
