      ...
      <div className="container mx-auto px-4">
        <nav className="flex flex-col md:flex-row md:flex-nowrap md:items-center md:justify-between gap-0 md:gap-4 py-4">
          <div className="flex items-center justify-between w-full md:w-auto">
            <NavLink to="/" className={(props) => `${linkClass(props)} shrink-0`} onClick={closeMenu}>
              L.P.F
            </NavLink>
            <button
              type="button"
          ...
          <div
            className={cn(
              'w-full md:w-auto md:flex-1 flex flex-col md:flex-row md:flex-nowrap md:items-center md:justify-evenly gap-0 md:gap-4 border-t border-gray-700 md:border-t-0 pt-2 md:pt-0',
              menuOpened ? 'flex' : 'hidden md:flex',
            )}
          >
